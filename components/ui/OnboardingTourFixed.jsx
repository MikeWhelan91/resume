  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-40 pointer-events-none">
        ...
        {targetElement && (
          <div
            className="absolute border-4 border-blue-400 rounded-lg shadow-[0_0_0_4px_rgba(59,130,246,0.2)] bg-bg/5 animate-pulse"
            style={{
      ...
      <div
        ...
        style={tooltipStyle}
      >
        <div className="bg-surface rounded-2xl shadow-2xl border border-border p-6 animate-scale-in">
          {/* Header */}
            ...
            <div className="flex items-center space-x-2">
              {currentStep > 0 && (
                <button
                  ...
                  className="px-3 py-1.5 text-sm text-muted hover:text-text border border-border rounded-lg hover:bg-surface transition-colors flex items-center space-x-1"
                >
