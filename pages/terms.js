          ...
          <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-12">
            <div className="text-center mb-8">
              <div className="flex items-center justify-center space-x-2 mb-4">
                ...
                <h1 className="text-3xl font-bold text-gray-900 dark:text-white dark:text-white">Terms of Service</h1>
              </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
          <div className="bg-surface text-text border border-border rounded-lg shadow-lg p-8 space-y-8">
            ...
            <section>
              ...
              <p className="text-gray-700 dark:text-gray-300 mb-4">To use certain features, you must create an account. You agree to:</p>
              <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 space-y-2">
            ...
            {/* User Content */}
            <section>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">5. User Content and Data</h2>
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">Content Accuracy</h3>
            ...
            <section>
              ...
              <p className="text-gray-700 dark:text-gray-300 mb-4">You may not use our Service to:</p>
              <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 space-y-2">
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">8. AI-Generated Content</h2>
              ...
              <p className="text-gray-700 dark:text-gray-300 mb-4">Regarding AI-generated content:</p>
              <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 space-y-2">
            ...
            <section>
              ...
              <p className="text-gray-700 dark:text-gray-300 mb-4">We disclaim all warranties, including:</p>
              <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 space-y-2 mb-4">
            ...
            <section>
              ...
              <p className="text-gray-700 dark:text-gray-300 mb-4">Either party may terminate your account:</p>
              <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 space-y-2">
