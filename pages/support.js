          ...
          <div className="grid lg:grid-cols-3 gap-8">
              ...
              <div className="bg-white rounded-2xl shadow-lg p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    ...
                    className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold py-3 px-6 rounded-lg hover:from-blue-700 hover:to-purple-700 transition-all duration-200 transform hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
                  >
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-2xl shadow-lg p-6">
                ...
                <div className="space-y-4">
                  <div>
                    <h4 className="font-medium text-gray-900 text-sm mb-1">How do I download my resume?</h4>
                    <p className="text-gray-600 text-xs">Use the download buttons on the results page to get PDF or DOCX files.</p>
                  </div>
                  <div>
                    <h4 className="font-medium text-gray-900 text-sm mb-1">Can I edit my resume after generating?</h4>
                    <p className="text-gray-600 text-xs">Yes, you can modify content and switch between different templates.</p>
                  </div>
                  <div>
                    <h4 className="font-medium text-gray-900 text-sm mb-1">Which template should I use?</h4>
                    <p className="text-gray-600 text-xs">Choose based on your industry - Professional for corporate, Creative for design roles.</p>
                  </div>
                </div>
              </div>
