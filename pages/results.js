...
export default function ResultsPage() {
  ...
  async function downloadResumePdf() {
    if (!result) return
    const data = { ...result.resumeData, accent, density, ats: atsMode }
  ...
  return (
    <>
      ...
      <div style={{
        ...
        <section style={{display:'grid', placeItems:'start', justifyItems:'center'}}>
          <PreviewFrame htmlDoc={cvHtml} />
        </section>
        <section style={{display:'grid', placeItems:'start', justifyItems:'center'}}>
          <PreviewFrame htmlDoc={coverHtml} />
        </section>
      </div>
    </>
  )
